...
module AP_MODULE_DECLARE_DATA proxy_ajp_modq_module;
                                ...
                                char *url, char *server_portstr)
{
    ...
    status = MODQ_ajp_send_header(conn, r, maxsize, uri);
                             ...
                             apr_port_t proxyport)
{
    ...
    while (retry < 2) {
        ...
        status = MODQ_ap_proxy_determine_connection(p, r, conf, worker, backend,
